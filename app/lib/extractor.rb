...
module Extractor
  ...
  def extract_entities_with_indices(text, options = {}, &block)
    ...
    entities.concat(extract_hashtags_with_indices(text, check_url_overlap: false))
    entities.concat(extract_mentions_or_lists_with_indices(text))
    entities.concat(extract_extra_uris_with_indices(text))
